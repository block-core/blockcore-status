...
function dataAjaxBegin() {
    $.bootstrapModalAlert({
        caption: 'Start operations',
        body: '<div class="alert alert-info"> <span class="fas fa-thumbs-up" aria-hidden="true"></span> Sending information to the server. Please wait a moment. </div>'
    });
    return true;
}
