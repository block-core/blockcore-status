...
{
    public partial class V2022_06_19_1337 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FailedPings = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GithubOrganizationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    HooksUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IssuesUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MembersUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PublicMembersUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    HasOrganizationProjects = table.Column<bool>(type: "bit", nullable: false),
                    HasRepositoryProjects = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    LatestDataUpdate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedByBrowserName = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedByIp = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CreatedByUserId = table.Column<int>(type: "int", nullable: true),
                    CreatedDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SshUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SvnUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MirrorUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GithubReleaseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Url = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AssetsUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UploadUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HtmlUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Id = table.Column<int>(type: "int", nullable: false),
                    NodeId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TagName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TargetCommitish = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Draft = table.Column<bool>(type: "bit", nullable: false),
                    Prerelease = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    PublishedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    TarballUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ZipballUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
